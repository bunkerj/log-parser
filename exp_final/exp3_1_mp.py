...
x pairwise constraints (using pairwise constraints as a corrective measure as
...
def run_exp3_2_full(data_config, label_counts, constraint_counts,
    ...
    # Labels x Constraints
    with mp.Pool(mp.cpu_count()) as pool:
        for n_labels in label_counts:
            results['ami_samples'][n_labels] = {}
            for n_constraints in constraint_counts:
                ...
                results['ami_samples'][n_labels][n_constraints] = ami_samples
...
if __name__ == '__main__':
    ...
    filename = 'exp3_1_results.p'
    results = run_exp3_2_full(data_config, label_counts, constraint_counts,
